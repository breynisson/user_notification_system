...
import user_notifications_pb2 as user__notifications__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in user_notifications_pb2_grpc.py depends on'
...
class NotificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                '/user_notifications.NotificationService/SendMessage',
                request_serializer=user__notifications__pb2.MessageRequest.SerializeToString,
                response_deserializer=user__notifications__pb2.MessageResponse.FromString,
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__notifications__pb2.MessageRequest.FromString,
                    response_serializer=user__notifications__pb2.MessageResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'user_notifications.NotificationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('user_notifications.NotificationService', rpc_method_handlers)
...
class NotificationService(object):
    ...
    def SendMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user_notifications.NotificationService/SendMessage',
            user__notifications__pb2.MessageRequest.SerializeToString,
            user__notifications__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
